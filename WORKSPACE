...
new_local_repository(
    ...
    build_file = "third_party/dart/BUILD.bazel",
)
...
go_repository(
    ...
    sum = "h1:1+zQlQqEEhUeStBTi653GZAnAuivZq/2hz+Iz+OP7rg=",
...
go_repository(
    ...
    sum = "h1:oj6yp1cr3vAo7EXJt9jCqfIzrwvFFVD6zI6VO+qNA6s=",
    version = "v0.0.0-20200324053659-5c746ccfa245",
)
